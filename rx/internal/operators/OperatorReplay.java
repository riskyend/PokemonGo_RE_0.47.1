  ...
  extends ConnectableObservable<T>
{
    ...
    new OperatorReplay(new Observable.OnSubscribe()
    {
      public void call(Subscriber<? super T> paramAnonymousSubscriber)
      {
        ...
        do
        {
          ...
          localObject1 = new OperatorReplay.ReplaySubscriber(this.val$curr, (OperatorReplay.ReplayBuffer)paramFunc0.call());
          ((OperatorReplay.ReplaySubscriber)localObject1).init();
        } while (!this.val$curr.compareAndSet(localObject2, localObject1));
        Object localObject2 = new OperatorReplay.InnerProducer((OperatorReplay.ReplaySubscriber)localObject1, paramAnonymousSubscriber);
    ...
    Observable.create(new Observable.OnSubscribe()
    {
      public void call(final Subscriber<? super R> paramAnonymousSubscriber)
      {
        try
        {
          ...
          Observable localObservable = (Observable)paramFunc1.call(localConnectableObservable);
          localObservable.subscribe(paramAnonymousSubscriber);
        ...
        {
          Exceptions.throwOrReport(localThrowable, paramAnonymousSubscriber);
        }
      }
    });
  }
  ...
  public static <T> ConnectableObservable<T> observeOn(final ConnectableObservable<T> paramConnectableObservable, Scheduler paramScheduler)
  {
    new ConnectableObservable(new Observable.OnSubscribe()
    {
      ...
      {
        this.val$observable.unsafeSubscribe(new Subscriber(paramAnonymousSubscriber)
        {
          ...
          {
            paramAnonymousSubscriber.onNext(paramAnonymous2T);
          }
        });
      }
    })
      ...
      for (;;)
      {
        ...
        while (!isUnsubscribed())
        {
          ...
          for (;;)
          {
            ...
            ((Producer)localObject3).request(l2);
            continue;
            l2 = l3 + l2;
            l1 = l2;
            if (l2 < 0L) {
            ...
            {
              this.maxUpstreamRequested = 0L;
              ((Producer)localObject3).request(l3);
            }
          }
          this.missed = false;
        }
    ...
    extends OperatorReplay.BoundedReplayBuffer<T>
  {
    ...
    void truncate()
    {
      ...
      while (localNode != null) {
        ...
        {
          if (((Timestamped)localNode.value).getTimestampMillis() > l1 - l2) {
            break;
          }
          i += 1;
          this.size -= 1;
    ...
    void truncateFinal()
    {
      ...
      OperatorReplay.Node localNode = (OperatorReplay.Node)((OperatorReplay.Node)localObject).get();
      int i = 0;
      while ((localNode != null) && (this.size > 1) && (((Timestamped)localNode.value).getTimestampMillis() <= l1 - l2))
      {
        i += 1;
        this.size -= 1;
        localObject = localNode;
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/rx/internal/operators/OperatorReplay.class
