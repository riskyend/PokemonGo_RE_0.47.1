      ...
      new Producer()
      {
        public void request(long paramAnonymousLong)
        {
          if (paramAnonymousLong < 0L) {
            throw new IllegalArgumentException("n >= 0 required but it was " + paramAnonymousLong);
          }
          if (paramAnonymousLong != 0L)
          {
            paramAnonymousLong = BackpressureUtils.multiplyCap(OperatorWindowWithSize.WindowExact.this.size, paramAnonymousLong);
            OperatorWindowWithSize.WindowExact.this.request(paramAnonymousLong);
          }
        }
      };
    }
    ...
    void drain()
    {
      ...
      for (long l1 = 0L;; l1 += 1L)
      {
        ...
        for (boolean bool1 = true;; bool1 = false)
        {
          ...
          int j = localAtomicInteger.addAndGet(-i);
          i = j;
          if (j != 0) {
            break label29;
          }
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/rx/internal/operators/OperatorWindowWithSize.class
