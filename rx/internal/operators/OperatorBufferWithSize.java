      ...
      new Producer()
      {
        public void request(long paramAnonymousLong)
        {
          if (paramAnonymousLong < 0L) {
            throw new IllegalArgumentException("n >= required but it was " + paramAnonymousLong);
          }
          if (paramAnonymousLong != 0L)
          {
            paramAnonymousLong = BackpressureUtils.multiplyCap(paramAnonymousLong, OperatorBufferWithSize.BufferExact.this.count);
            OperatorBufferWithSize.BufferExact.this.request(paramAnonymousLong);
          }
        }
      };
    }
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/rx/internal/operators/OperatorBufferWithSize.class
