  ...
  public static <T0> FuncN<Void> fromAction(Action1<? super T0> paramAction1)
  {
    new FuncN()
    {
      public Void call(Object... paramAnonymousVarArgs)
      {
        ...
        this.val$f.call(paramAnonymousVarArgs[0]);
        return null;
      }
    };
  }
  ...
  public static <T0, T1> FuncN<Void> fromAction(Action2<? super T0, ? super T1> paramAction2)
  {
    new FuncN()
    {
      public Void call(Object... paramAnonymousVarArgs)
      {
        ...
        this.val$f.call(paramAnonymousVarArgs[0], paramAnonymousVarArgs[1]);
        return null;
      }
    };
  }
  ...
  public static <T0, T1, T2> FuncN<Void> fromAction(Action3<? super T0, ? super T1, ? super T2> paramAction3)
  {
    new FuncN()
    {
      public Void call(Object... paramAnonymousVarArgs)
      {
        ...
        this.val$f.call(paramAnonymousVarArgs[0], paramAnonymousVarArgs[1], paramAnonymousVarArgs[2]);
        return null;
      }
    };
  }
  ...
  public static <T0, R> FuncN<R> fromFunc(Func1<? super T0, ? extends R> paramFunc1)
  {
    new FuncN()
    {
      public R call(Object... paramAnonymousVarArgs)
      {
        ...
        return (R)this.val$f.call(paramAnonymousVarArgs[0]);
      }
    };
  }
  ...
  public static <T0, T1, R> FuncN<R> fromFunc(Func2<? super T0, ? super T1, ? extends R> paramFunc2)
  {
    new FuncN()
    {
      public R call(Object... paramAnonymousVarArgs)
      {
        ...
        return (R)this.val$f.call(paramAnonymousVarArgs[0], paramAnonymousVarArgs[1]);
      }
    };
  }
  ...
  public static <T0, T1, T2, R> FuncN<R> fromFunc(Func3<? super T0, ? super T1, ? super T2, ? extends R> paramFunc3)
  {
    new FuncN()
    {
      public R call(Object... paramAnonymousVarArgs)
      {
        ...
        return (R)this.val$f.call(paramAnonymousVarArgs[0], paramAnonymousVarArgs[1], paramAnonymousVarArgs[2]);
      }
    };
  }
  ...
  public static <T0, T1, T2, T3, R> FuncN<R> fromFunc(Func4<? super T0, ? super T1, ? super T2, ? super T3, ? extends R> paramFunc4)
  {
    new FuncN()
    {
      public R call(Object... paramAnonymousVarArgs)
      {
        ...
        return (R)this.val$f.call(paramAnonymousVarArgs[0], paramAnonymousVarArgs[1], paramAnonymousVarArgs[2], paramAnonymousVarArgs[3]);
      }
    };
  }
  ...
  public static <T0, T1, T2, T3, T4, R> FuncN<R> fromFunc(Func5<? super T0, ? super T1, ? super T2, ? super T3, ? super T4, ? extends R> paramFunc5)
  {
    new FuncN()
    {
      public R call(Object... paramAnonymousVarArgs)
      {
        ...
        return (R)this.val$f.call(paramAnonymousVarArgs[0], paramAnonymousVarArgs[1], paramAnonymousVarArgs[2], paramAnonymousVarArgs[3], paramAnonymousVarArgs[4]);
      }
    };
  }
  ...
  public static <T0, T1, T2, T3, T4, T5, R> FuncN<R> fromFunc(Func6<? super T0, ? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> paramFunc6)
  {
    new FuncN()
    {
      public R call(Object... paramAnonymousVarArgs)
      {
        ...
        return (R)this.val$f.call(paramAnonymousVarArgs[0], paramAnonymousVarArgs[1], paramAnonymousVarArgs[2], paramAnonymousVarArgs[3], paramAnonymousVarArgs[4], paramAnonymousVarArgs[5]);
      }
    };
  }
  ...
  public static <T0, T1, T2, T3, T4, T5, T6, R> FuncN<R> fromFunc(Func7<? super T0, ? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? extends R> paramFunc7)
  {
    new FuncN()
    {
      public R call(Object... paramAnonymousVarArgs)
      {
        ...
        return (R)this.val$f.call(paramAnonymousVarArgs[0], paramAnonymousVarArgs[1], paramAnonymousVarArgs[2], paramAnonymousVarArgs[3], paramAnonymousVarArgs[4], paramAnonymousVarArgs[5], paramAnonymousVarArgs[6]);
      }
    };
  }
  ...
  public static <T0, T1, T2, T3, T4, T5, T6, T7, R> FuncN<R> fromFunc(Func8<? super T0, ? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> paramFunc8)
  {
    new FuncN()
    {
      public R call(Object... paramAnonymousVarArgs)
      {
        ...
        return (R)this.val$f.call(paramAnonymousVarArgs[0], paramAnonymousVarArgs[1], paramAnonymousVarArgs[2], paramAnonymousVarArgs[3], paramAnonymousVarArgs[4], paramAnonymousVarArgs[5], paramAnonymousVarArgs[6], paramAnonymousVarArgs[7]);
      }
    };
  }
  ...
  public static <T0, T1, T2, T3, T4, T5, T6, T7, T8, R> FuncN<R> fromFunc(Func9<? super T0, ? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> paramFunc9)
  {
    new FuncN()
    {
      public R call(Object... paramAnonymousVarArgs)
      {
        ...
        return (R)this.val$f.call(paramAnonymousVarArgs[0], paramAnonymousVarArgs[1], paramAnonymousVarArgs[2], paramAnonymousVarArgs[3], paramAnonymousVarArgs[4], paramAnonymousVarArgs[5], paramAnonymousVarArgs[6], paramAnonymousVarArgs[7], paramAnonymousVarArgs[8]);
      }
    };
  }
}
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/rx/functions/Functions.class
