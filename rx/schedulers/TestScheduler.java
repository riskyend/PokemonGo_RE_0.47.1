    ...
    extends Scheduler.Worker
  {
    ...
    public Subscription schedule(final Action0 paramAction0)
    {
      ...
      Subscriptions.create(new Action0()
      {
        public void call()
        {
          TestScheduler.this.queue.remove(paramAction0);
        }
      });
    }
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/rx/schedulers/TestScheduler.class
