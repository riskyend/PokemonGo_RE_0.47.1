  ...
  implements f, Runnable
{
  ...
  private long b()
  {
    long l2 = 0L;
    long l3 = this.j;
    long l4 = System.currentTimeMillis() - this.c;
    long l1 = l3;
    if (l4 > 0L)
    {
      l3 -= l4;
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/crittercism/android/g.class
