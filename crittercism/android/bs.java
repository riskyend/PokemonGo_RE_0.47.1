...
public final class bs
{
  ...
  private boolean f()
  {
    ...
    do
    {
      ...
      File[] arrayOfFile = g();
      locala1 = null;
      if (arrayOfFile.length > locala2.a) {
        locala1 = arrayOfFile[locala2.a];
      }
  ...
  private File[] h()
  {
    File[] arrayOfFile2 = this.a.listFiles();
  ...
  public final bs a(Context paramContext)
  {
    ...
    return new bs(new File(paramContext.getFilesDir().getAbsolutePath() + "//com.crittercism/pending/" + str), this.h, this.d, this.g, this.f, this.b);
  }
  ...
  public final void a(bs parambs)
  {
    ...
    {
      return;
      j = this.a.getName().compareTo(parambs.a.getName());
    } while (j == 0);
    bs localbs2;
    if (j < 0) {
      localbs2 = parambs;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else
        {
          ...
          {
            File localFile = new File(parambs.a, arrayOfFile[j].getName());
            arrayOfFile[j].renameTo(localFile);
            j += 1;
          }
          parambs.e();
          parambs = this.c.iterator();
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/crittercism/android/bs.class
