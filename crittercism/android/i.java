...
public final class i
{
  ...
  private boolean h()
  {
    ...
    for (;;)
    {
      try
      {
        localObject = new ad(localSocketImplFactory, this.h, this.i);
        a((SocketImplFactory)localObject);
        this.d = ((ad)localObject);
        return true;
      }
      catch (cl localcl3)
      {
      ...
      localObject = new ad((Class)localObject, this.h, this.i);
  ...
  public final boolean a()
  {
    ...
    for (;;)
    {
      ...
      continue;
      this.e = new ab(localck, this.h, this.i);
  ...
  public final boolean c()
  {
    ...
    ab localab = new ab(localcl1, this.h, this.i);
    try
    {
      a(localab);
      this.f = localab;
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/crittercism/android/i.class
