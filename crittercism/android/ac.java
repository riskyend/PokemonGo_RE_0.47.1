  ...
  implements ae
{
  ...
  public final InputStream getInputStream()
  {
    ...
    if (localInputStream != null) {
      try
      {
        if ((this.m != null) && (this.m.a(localInputStream))) {
          return this.m;
        }
        this.m = new x(this, localInputStream, this.i);
        x localx = this.m;
        return localx;
      }
      catch (ThreadDeath localThreadDeath)
  ...
  public final OutputStream getOutputStream()
  {
    ...
    if (localOutputStream != null) {
      try
      {
        if ((this.l != null) && (this.l.a(localOutputStream))) {
          return this.l;
        }
        this.l = new w(this, localOutputStream);
        w localw = this.l;
        return localw;
      }
      catch (ThreadDeath localThreadDeath)
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/crittercism/android/ac.class
