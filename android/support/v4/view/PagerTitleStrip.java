  ...
  implements ViewPager.Decor
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int m = View.MeasureSpec.makeMeasureSpec(Math.max(0, (int)(paramInt1 * 0.8F)), Integer.MIN_VALUE);
    int n = View.MeasureSpec.makeMeasureSpec(Math.min(0, paramInt2 - k), Integer.MIN_VALUE);
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/android/support/v4/view/PagerTitleStrip.class
