...
public class VolleyLog
{
  ...
  static class MarkerLog
  {
    ...
    public void finish(String paramString)
    {
      ...
      //   2: aload_0
      //   3: iconst_1
      //   4: putfield 38	com/mopub/volley/VolleyLog$MarkerLog:mFinished	Z
      //   7: aload_0
      //   8: invokespecial 90	com/mopub/volley/VolleyLog$MarkerLog:getTotalDuration	()J
      //   11: lstore 4
      //   13: lload 4
      //   15: lconst_0
      //   16: lcmp
      ...
      //   22: return
      //   23: aload_0
      //   24: getfield 36	com/mopub/volley/VolleyLog$MarkerLog:mMarkers	Ljava/util/List;
      //   27: iconst_0
      //   28: invokeinterface 50 2 0
      //   33: checkcast 9	com/mopub/volley/VolleyLog$MarkerLog$Marker
      //   36: getfield 53	com/mopub/volley/VolleyLog$MarkerLog$Marker:time	J
      //   39: lstore_2
      //   40: ldc 92
      //   42: iconst_2
      ...
      //   56: aload_1
      //   57: aastore
      //   58: invokestatic 101	com/mopub/volley/VolleyLog:d	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   61: aload_0
      //   62: getfield 36	com/mopub/volley/VolleyLog$MarkerLog:mMarkers	Ljava/util/List;
      ...
      //   86: checkcast 9	com/mopub/volley/VolleyLog$MarkerLog$Marker
      //   89: astore 6
      //   91: aload 6
      //   93: getfield 53	com/mopub/volley/VolleyLog$MarkerLog$Marker:time	J
      //   96: lstore 4
      //   98: ldc 117
      //   100: iconst_3
      ...
      //   115: iconst_1
      //   116: aload 6
      //   118: getfield 120	com/mopub/volley/VolleyLog$MarkerLog$Marker:thread	J
      //   121: invokestatic 98	java/lang/Long:valueOf	(J)Ljava/lang/Long;
      //   124: aastore
      //   125: dup
      //   126: iconst_2
      //   127: aload 6
      //   129: getfield 124	com/mopub/volley/VolleyLog$MarkerLog$Marker:name	Ljava/lang/String;
      //   132: aastore
      //   133: invokestatic 101	com/mopub/volley/VolleyLog:d	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   136: lload 4
      //   138: lstore_2
      //   139: goto -68 -> 71
      //   142: astore_1
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/mopub/volley/VolleyLog.class
