  ...
  implements Network
{
    ...
    throws VolleyError
  {
    ...
    //   38: aload 9
    //   40: aload_1
    //   41: invokevirtual 250	com/mopub/volley/Request:getCacheEntry	()Lcom/mopub/volley/Cache$Entry;
    //   44: invokespecial 252	com/mopub/volley/toolbox/BasicNetwork:addCacheHeaders	(Ljava/util/Map;Lcom/mopub/volley/Cache$Entry;)V
    //   47: aload 8
    //   49: astore 5
    //   51: aload 7
    //   53: astore 6
    //   55: aload_0
    //   56: getfield 41	com/mopub/volley/toolbox/BasicNetwork:mHttpStack	Lcom/mopub/volley/toolbox/HttpStack;
    //   59: aload_1
    //   60: aload 9
    ...
    //   117: invokestatic 269	com/mopub/volley/toolbox/BasicNetwork:convertHeaders	([Lorg/apache/http/Header;)Ljava/util/Map;
    //   120: astore 8
    //   122: iload_2
    //   123: sipush 304
    ...
    //   135: astore 6
    //   137: aload_1
    //   138: invokevirtual 250	com/mopub/volley/Request:getCacheEntry	()Lcom/mopub/volley/Cache$Entry;
    //   141: astore 9
    //   143: aload 9
    ...
    //   152: aload 7
    //   154: astore 6
    //   156: new 271	com/mopub/volley/NetworkResponse
    //   159: dup
    //   160: sipush 304
    //   163: aconst_null
    //   164: aload 8
    ...
    //   170: lload_3
    //   171: lsub
    //   172: invokespecial 274	com/mopub/volley/NetworkResponse:<init>	(I[BLjava/util/Map;ZJ)V
    //   175: areturn
    //   176: aload 8
    //   178: astore 5
    //   180: aload 7
    //   182: astore 6
    //   184: aload 9
    //   186: getfield 278	com/mopub/volley/Cache$Entry:responseHeaders	Ljava/util/Map;
    //   189: aload 8
    ...
    //   200: aload 7
    //   202: astore 6
    //   204: new 271	com/mopub/volley/NetworkResponse
    //   207: dup
    //   208: sipush 304
    //   211: aload 9
    //   213: getfield 286	com/mopub/volley/Cache$Entry:data	[B
    //   216: aload 9
    //   218: getfield 278	com/mopub/volley/Cache$Entry:responseHeaders	Ljava/util/Map;
    //   221: iconst_1
    //   222: invokestatic 229	android/os/SystemClock:elapsedRealtime	()J
    //   225: lload_3
    //   226: lsub
    //   227: invokespecial 274	com/mopub/volley/NetworkResponse:<init>	(I[BLjava/util/Map;ZJ)V
    //   230: areturn
    //   231: aload 8
    //   233: astore 5
    //   235: aload 7
    ...
    //   265: invokespecial 292	com/mopub/volley/toolbox/BasicNetwork:entityToBytes	(Lorg/apache/http/HttpEntity;)[B
    //   268: astore 9
    //   270: aload 9
    //   272: astore 5
    //   274: aload_0
    ...
    //   281: aload 5
    //   283: aload 10
    //   285: invokespecial 294	com/mopub/volley/toolbox/BasicNetwork:logSlowRequests	(JLcom/mopub/volley/Request;[BLorg/apache/http/StatusLine;)V
    //   288: iload_2
    //   289: sipush 200
    ...
    //   312: ldc_w 297
    //   315: aload_1
    //   316: new 299	com/mopub/volley/TimeoutError
    //   319: dup
    //   320: invokespecial 300	com/mopub/volley/TimeoutError:<init>	()V
    //   323: invokestatic 302	com/mopub/volley/toolbox/BasicNetwork:attemptRetryOnException	(Ljava/lang/String;Lcom/mopub/volley/Request;Lcom/mopub/volley/VolleyError;)V
    //   326: goto -322 -> 4
    //   329: aload 8
    //   331: astore 5
    //   333: aload 7
    ...
    //   344: astore 5
    //   346: goto -72 -> 274
    //   349: new 271	com/mopub/volley/NetworkResponse
    //   352: dup
    //   353: iload_2
    //   354: aload 5
    //   356: aload 8
    ...
    //   362: lload_3
    //   363: lsub
    //   364: invokespecial 274	com/mopub/volley/NetworkResponse:<init>	(I[BLjava/util/Map;ZJ)V
    //   367: astore 6
    //   369: aload 6
    //   371: areturn
    //   372: astore 5
    //   374: ldc_w 304
    //   377: aload_1
    //   378: new 299	com/mopub/volley/TimeoutError
    //   381: dup
    //   382: invokespecial 300	com/mopub/volley/TimeoutError:<init>	()V
    //   385: invokestatic 302	com/mopub/volley/toolbox/BasicNetwork:attemptRetryOnException	(Ljava/lang/String;Lcom/mopub/volley/Request;Lcom/mopub/volley/VolleyError;)V
    //   388: goto -384 -> 4
    //   391: astore 5
    ...
    //   410: aload_1
    //   411: invokevirtual 318	com/mopub/volley/Request:getUrl	()Ljava/lang/String;
    ...
    //   476: iconst_1
    //   477: aload_1
    //   478: invokevirtual 318	com/mopub/volley/Request:getUrl	()Ljava/lang/String;
    //   481: aastore
    //   482: invokestatic 329	com/mopub/volley/VolleyLog:e	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   485: aload 9
    //   487: ifnull +76 -> 563
    //   490: new 271	com/mopub/volley/NetworkResponse
    //   493: dup
    //   494: iload_2
    //   495: aload 9
    //   497: aload 8
    ...
    //   503: lload_3
    //   504: lsub
    //   505: invokespecial 274	com/mopub/volley/NetworkResponse:<init>	(I[BLjava/util/Map;ZJ)V
    //   508: astore 5
    //   510: iload_2
    //   511: sipush 401
    ...
    //   524: ldc_w 331
    //   527: aload_1
    //   528: new 333	com/mopub/volley/AuthFailureError
    //   531: dup
    //   532: aload 5
    //   534: invokespecial 336	com/mopub/volley/AuthFailureError:<init>	(Lcom/mopub/volley/NetworkResponse;)V
    //   537: invokestatic 302	com/mopub/volley/toolbox/BasicNetwork:attemptRetryOnException	(Ljava/lang/String;Lcom/mopub/volley/Request;Lcom/mopub/volley/VolleyError;)V
    //   540: goto -536 -> 4
    //   543: new 338	com/mopub/volley/NoConnectionError
    //   546: dup
    //   547: aload 6
    //   549: invokespecial 341	com/mopub/volley/NoConnectionError:<init>	(Ljava/lang/Throwable;)V
    //   552: athrow
    //   553: new 147	com/mopub/volley/ServerError
    //   556: dup
    //   557: aload 5
    //   559: invokespecial 342	com/mopub/volley/ServerError:<init>	(Lcom/mopub/volley/NetworkResponse;)V
    //   562: athrow
    //   563: new 344	com/mopub/volley/NetworkError
    //   566: dup
    //   567: aconst_null
    //   568: invokespecial 345	com/mopub/volley/NetworkError:<init>	(Lcom/mopub/volley/NetworkResponse;)V
    //   571: athrow
    //   572: astore 6
    //   574: aload 5
    //   576: astore 9
    ...
    //   508	67	5	localNetworkResponse	com.mopub.volley.NetworkResponse
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/mopub/volley/toolbox/BasicNetwork.class
