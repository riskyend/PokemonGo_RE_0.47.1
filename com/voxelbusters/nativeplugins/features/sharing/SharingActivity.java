  ...
  extends Activity
{
  ...
  private void shareItem(String paramString1, String paramString2, String paramString3, String paramString4, String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      if (paramString4.activityInfo != null) {}
      for (paramString1 = paramString4.activityInfo.packageName;; paramString1 = null)
      {
        ...
        ((Intent)localObject).setComponent(new ComponentName(paramString1, paramString4.activityInfo.name));
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = this.bundleInfo.getString("type");
    if (StringUtility.isNullOrEmpty(paramBundle))
    {
      shareItem(this.bundleInfo.getString("message"), this.bundleInfo.getString("url"), this.bundleInfo.getString("image-path"), paramBundle, this.bundleInfo.getStringArray("exclude-list"));
      return;
    }
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/voxelbusters/nativeplugins/features/sharing/SharingActivity.class
