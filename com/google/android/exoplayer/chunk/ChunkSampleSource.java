  ...
  implements SampleSource, SampleSource.SampleSourceReader, Loader.Callback
{
  ...
  public int readData(int paramInt, long paramLong, MediaFormatHolder paramMediaFormatHolder, SampleHolder paramSampleHolder)
  {
    ...
    if ((this.downstreamFormat == null) || (!this.downstreamFormat.equals(localBaseMediaChunk.format)))
    {
      notifyDownstreamFormatChanged(localBaseMediaChunk.format, localBaseMediaChunk.trigger, localBaseMediaChunk.startTimeUs);
      this.downstreamFormat = localBaseMediaChunk.format;
    }
    if ((paramInt != 0) || (localBaseMediaChunk.isMediaFormatFinal))
    {
      MediaFormat localMediaFormat = localBaseMediaChunk.getMediaFormat();
      if (!localMediaFormat.equals(this.downstreamMediaFormat))
      {
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/exoplayer/chunk/ChunkSampleSource.class
