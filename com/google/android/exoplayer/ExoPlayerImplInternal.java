  ...
  implements Handler.Callback
{
    ...
    if (k < this.renderers.length)
    {
      ...
      if (i1 > 0)
      {
        ...
        if (i1 >= 0)
        {
          ...
          {
            localTrackRenderer.enable(i1, this.positionUs, false);
    ...
    throws ExoPlaybackException
  {
    ...
    {
      MediaClock localMediaClock = paramArrayOfTrackRenderer[i].getMediaClock();
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        this.rendererMediaClockSource = paramArrayOfTrackRenderer[i];
        i += 1;
        break;
      }
    }
    ...
    throws ExoPlaybackException
  {
    // Byte code:
    //   0: aload_2
    //   1: checkcast 376	android/util/Pair
    //   4: astore_2
    //   5: aload_2
    //   6: getfield 380	android/util/Pair:first	Ljava/lang/Object;
    //   9: checkcast 382	com/google/android/exoplayer/ExoPlayer$ExoPlayerComponent
    //   12: iload_1
    //   13: aload_2
    //   14: getfield 385	android/util/Pair:second	Ljava/lang/Object;
    //   17: invokeinterface 388 3 0
    //   22: aload_0
    //   23: getfield 104	com/google/android/exoplayer/ExoPlayerImplInternal:state	I
    //   26: iconst_1
    //   27: if_icmpeq +21 -> 48
    //   30: aload_0
    //   31: getfield 104	com/google/android/exoplayer/ExoPlayerImplInternal:state	I
    //   34: iconst_2
    //   35: if_icmpeq +13 -> 48
    //   38: aload_0
    //   39: getfield 156	com/google/android/exoplayer/ExoPlayerImplInternal:handler	Landroid/os/Handler;
    //   42: bipush 7
    //   44: invokevirtual 299	android/os/Handler:sendEmptyMessage	(I)Z
    //   47: pop
    //   48: aload_0
    //   49: monitorenter
    //   50: aload_0
    //   51: aload_0
    //   52: getfield 84	com/google/android/exoplayer/ExoPlayerImplInternal:customMessagesProcessed	I
    //   55: iconst_1
    //   56: iadd
    //   57: putfield 84	com/google/android/exoplayer/ExoPlayerImplInternal:customMessagesProcessed	I
    //   60: aload_0
    //   61: invokevirtual 343	java/lang/Object:notifyAll	()V
    //   64: aload_0
    //   65: monitorexit
    //   66: return
    //   67: astore_2
    ...
    //   75: aload_0
    //   76: aload_0
    //   77: getfield 84	com/google/android/exoplayer/ExoPlayerImplInternal:customMessagesProcessed	I
    //   80: iconst_1
    //   81: iadd
    //   82: putfield 84	com/google/android/exoplayer/ExoPlayerImplInternal:customMessagesProcessed	I
    //   85: aload_0
    //   86: invokevirtual 343	java/lang/Object:notifyAll	()V
    //   89: aload_0
    //   90: monitorexit
    //   91: aload_2
    //   92: athrow
    ...
    throws ExoPlaybackException
  {
    ...
    for (;;)
    {
      localTrackRenderer.enable(paramInt2, this.positionUs, bool);
      this.enabledRenderers.add(localTrackRenderer);
      if (paramInt1 != 0) {
  ...
  public void blockingSendMessage(ExoPlayer.ExoPlayerComponent paramExoPlayerComponent, int paramInt, Object paramObject)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 340	com/google/android/exoplayer/ExoPlayerImplInternal:released	Z
    //   6: ifeq +38 -> 44
    //   9: ldc 38
    //   11: new 425	java/lang/StringBuilder
    //   14: dup
    //   15: invokespecial 426	java/lang/StringBuilder:<init>	()V
    //   18: ldc_w 428
    //   21: invokevirtual 432	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   24: iload_2
    //   25: invokevirtual 435	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   28: ldc_w 437
    //   31: invokevirtual 432	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   34: invokevirtual 441	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   37: invokestatic 445	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   40: pop
    //   41: aload_0
    //   42: monitorexit
    //   43: return
    //   44: aload_0
    //   45: getfield 82	com/google/android/exoplayer/ExoPlayerImplInternal:customMessagesSent	I
    //   48: istore 4
    //   50: aload_0
    //   51: iload 4
    //   53: iconst_1
    //   54: iadd
    //   55: putfield 82	com/google/android/exoplayer/ExoPlayerImplInternal:customMessagesSent	I
    //   58: aload_0
    //   59: getfield 156	com/google/android/exoplayer/ExoPlayerImplInternal:handler	Landroid/os/Handler;
    //   62: bipush 9
    //   64: iload_2
    //   65: iconst_0
    //   66: aload_1
    //   67: aload_3
    //   68: invokestatic 449	android/util/Pair:create	(Ljava/lang/Object;Ljava/lang/Object;)Landroid/util/Pair;
    //   71: invokevirtual 290	android/os/Handler:obtainMessage	(IIILjava/lang/Object;)Landroid/os/Message;
    //   74: invokevirtual 295	android/os/Message:sendToTarget	()V
    //   77: aload_0
    //   78: getfield 84	com/google/android/exoplayer/ExoPlayerImplInternal:customMessagesProcessed	I
    //   81: istore_2
    //   82: iload_2
    //   83: iload 4
    //   85: if_icmpgt -44 -> 41
    //   88: aload_0
    //   89: invokevirtual 452	java/lang/Object:wait	()V
    //   92: goto -15 -> 77
    //   95: astore_1
    //   96: invokestatic 458	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   99: invokevirtual 461	java/lang/Thread:interrupt	()V
    //   102: goto -25 -> 77
    //   105: astore_1
    //   106: aload_0
    //   107: monitorexit
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/exoplayer/ExoPlayerImplInternal.class
