...
public final class MediaFormat
{
  ...
  {
    return new MediaFormat(paramString1, paramString2, paramInt1, paramInt2, paramLong, -1, -1, -1, -1.0F, paramInt3, paramInt4, paramString3, Long.MAX_VALUE, paramList, false, -1, -1, -1, -1);
  }
  
  public static MediaFormat createFormatForMimeType(String paramString1, String paramString2, int paramInt, long paramLong)
  {
    return new MediaFormat(paramString1, paramString2, paramInt, -1, paramLong, -1, -1, -1, -1.0F, -1, -1, null, Long.MAX_VALUE, null, false, -1, -1, -1, -1);
  }
  ...
  {
    return new MediaFormat(paramString1, paramString2, paramInt, -1, paramLong1, -1, -1, -1, -1.0F, -1, -1, paramString3, paramLong2, null, false, -1, -1, -1, -1);
  }
  ...
  {
    return new MediaFormat(paramString1, paramString2, paramInt1, paramInt2, paramLong, paramInt3, paramInt4, paramInt5, paramFloat, -1, -1, null, Long.MAX_VALUE, paramList, false, -1, -1, -1, -1);
  }
  ...
  {
    return new MediaFormat(paramString, this.mimeType, -1, -1, this.durationUs, -1, -1, -1, -1.0F, -1, -1, null, Long.MAX_VALUE, null, true, this.maxWidth, this.maxHeight, -1, -1);
  }
  ...
  {
    return new MediaFormat(this.trackId, this.mimeType, this.bitrate, this.maxInputSize, this.durationUs, this.width, this.height, this.rotationDegrees, this.pixelWidthHeightRatio, this.channelCount, this.sampleRate, this.language, this.subsampleOffsetUs, this.initializationData, this.adaptive, paramInt1, paramInt2, this.encoderDelay, this.encoderPadding);
  }
  
  public MediaFormat copyWithSubsampleOffsetUs(long paramLong)
  {
    return new MediaFormat(this.trackId, this.mimeType, this.bitrate, this.maxInputSize, this.durationUs, this.width, this.height, this.rotationDegrees, this.pixelWidthHeightRatio, this.channelCount, this.sampleRate, this.language, paramLong, this.initializationData, this.adaptive, this.maxWidth, this.maxHeight, this.encoderDelay, this.encoderPadding);
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((this.adaptive != ((MediaFormat)paramObject).adaptive) || (this.bitrate != ((MediaFormat)paramObject).bitrate) || (this.maxInputSize != ((MediaFormat)paramObject).maxInputSize) || (this.width != ((MediaFormat)paramObject).width) || (this.height != ((MediaFormat)paramObject).height) || (this.rotationDegrees != ((MediaFormat)paramObject).rotationDegrees) || (this.pixelWidthHeightRatio != ((MediaFormat)paramObject).pixelWidthHeightRatio) || (this.maxWidth != ((MediaFormat)paramObject).maxWidth) || (this.maxHeight != ((MediaFormat)paramObject).maxHeight) || (this.encoderDelay != ((MediaFormat)paramObject).encoderDelay) || (this.encoderPadding != ((MediaFormat)paramObject).encoderPadding) || (this.channelCount != ((MediaFormat)paramObject).channelCount) || (this.sampleRate != ((MediaFormat)paramObject).sampleRate) || (!Util.areEqual(this.trackId, ((MediaFormat)paramObject).trackId)) || (!Util.areEqual(this.language, ((MediaFormat)paramObject).language)) || (!Util.areEqual(this.mimeType, ((MediaFormat)paramObject).mimeType)) || (this.initializationData.size() != ((MediaFormat)paramObject).initializationData.size())) {
      return false;
    }
    int i = 0;
  ...
  public int hashCode()
  {
    ...
    if (this.hashCode == 0)
    {
      ...
      if (this.trackId == null)
      {
        ...
        i7 = this.maxWidth;
        i8 = this.maxHeight;
        i9 = this.encoderDelay;
        i10 = this.encoderPadding;
        i11 = this.channelCount;
        i12 = this.sampleRate;
      ...
      for (;;)
      {
        j = ((((((((((((((((i + 527) * 31 + j) * 31 + n) * 31 + i1) * 31 + i2) * 31 + i3) * 31 + i4) * 31 + i5) * 31 + i6) * 31 + k) * 31 + i7) * 31 + i8) * 31 + i9) * 31 + i10) * 31 + i11) * 31 + i12) * 31 + m;
        i = 0;
        while (i < this.initializationData.size())
        {
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/exoplayer/MediaFormat.class
