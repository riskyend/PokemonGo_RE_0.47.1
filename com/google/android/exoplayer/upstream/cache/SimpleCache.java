  ...
  implements Cache
{
  ...
  private CacheSpan startReadWriteNonBlocking(CacheSpan paramCacheSpan)
  {
    ...
    //   2: aload_0
    //   3: aload_1
    //   4: invokespecial 114	com/google/android/exoplayer/upstream/cache/SimpleCache:getSpan	(Lcom/google/android/exoplayer/upstream/cache/CacheSpan;)Lcom/google/android/exoplayer/upstream/cache/CacheSpan;
    //   7: astore_2
    //   8: aload_2
    //   9: getfield 202	com/google/android/exoplayer/upstream/cache/CacheSpan:isCached	Z
    //   12: ifeq +47 -> 59
    //   15: aload_0
    //   16: getfield 39	com/google/android/exoplayer/upstream/cache/SimpleCache:cachedSpans	Ljava/util/HashMap;
    //   19: aload_2
    //   20: getfield 67	com/google/android/exoplayer/upstream/cache/CacheSpan:key	Ljava/lang/String;
    //   23: invokevirtual 71	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   26: checkcast 73	java/util/TreeSet
    //   29: astore_3
    //   30: aload_3
    //   31: aload_2
    //   32: invokevirtual 207	java/util/TreeSet:remove	(Ljava/lang/Object;)Z
    //   35: invokestatic 213	com/google/android/exoplayer/util/Assertions:checkState	(Z)V
    //   38: aload_2
    //   39: invokevirtual 217	com/google/android/exoplayer/upstream/cache/CacheSpan:touch	()Lcom/google/android/exoplayer/upstream/cache/CacheSpan;
    //   42: astore_1
    //   43: aload_3
    //   44: aload_1
    //   45: invokevirtual 82	java/util/TreeSet:add	(Ljava/lang/Object;)Z
    //   48: pop
    //   49: aload_0
    //   50: aload_2
    //   51: aload_1
    //   52: invokespecial 219	com/google/android/exoplayer/upstream/cache/SimpleCache:notifySpanTouched	(Lcom/google/android/exoplayer/upstream/cache/CacheSpan;Lcom/google/android/exoplayer/upstream/cache/CacheSpan;)V
    //   55: aload_0
    //   56: monitorexit
    //   57: aload_1
    //   58: areturn
    //   59: aload_0
    //   60: getfield 37	com/google/android/exoplayer/upstream/cache/SimpleCache:lockedSpans	Ljava/util/HashMap;
    //   63: aload_1
    //   64: getfield 67	com/google/android/exoplayer/upstream/cache/CacheSpan:key	Ljava/lang/String;
    //   67: invokevirtual 222	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   70: ifne +21 -> 91
    //   73: aload_0
    //   74: getfield 37	com/google/android/exoplayer/upstream/cache/SimpleCache:lockedSpans	Ljava/util/HashMap;
    //   77: aload_1
    //   78: getfield 67	com/google/android/exoplayer/upstream/cache/CacheSpan:key	Ljava/lang/String;
    //   81: aload_2
    //   82: invokevirtual 78	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   85: pop
    //   86: aload_2
    //   87: astore_1
    //   88: goto -33 -> 55
  ...
  public NavigableSet<CacheSpan> getCachedSpans(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 39	com/google/android/exoplayer/upstream/cache/SimpleCache:cachedSpans	Ljava/util/HashMap;
    //   6: aload_1
    //   7: invokevirtual 71	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   10: checkcast 73	java/util/TreeSet
    //   13: astore_1
    //   14: aload_1
    //   15: ifnonnull +9 -> 24
    //   18: aconst_null
    ...
    //   22: aload_1
    //   23: areturn
    //   24: new 73	java/util/TreeSet
    //   27: dup
    //   28: aload_1
    //   29: invokespecial 241	java/util/TreeSet:<init>	(Ljava/util/SortedSet;)V
    //   32: astore_1
    //   33: goto -13 -> 20
    //   36: astore_1
    //   37: aload_0
  ...
  public void releaseHoleSpan(CacheSpan paramCacheSpan)
  {
    ...
    //   2: aload_1
    //   3: aload_0
    //   4: getfield 37	com/google/android/exoplayer/upstream/cache/SimpleCache:lockedSpans	Ljava/util/HashMap;
    //   7: aload_1
    //   8: getfield 67	com/google/android/exoplayer/upstream/cache/CacheSpan:key	Ljava/lang/String;
    //   11: invokevirtual 272	java/util/HashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   14: if_acmpne +16 -> 30
    //   17: iconst_1
    //   18: istore_2
    //   19: iload_2
    //   20: invokestatic 213	com/google/android/exoplayer/util/Assertions:checkState	(Z)V
    //   23: aload_0
    //   24: invokevirtual 237	java/lang/Object:notifyAll	()V
    //   27: aload_0
    //   28: monitorexit
    //   29: return
    //   30: iconst_0
    ...
    throws java.lang.InterruptedException
  {
    ...
    //   2: aload_1
    //   3: lload_2
    //   4: invokestatic 256	com/google/android/exoplayer/upstream/cache/CacheSpan:createLookup	(Ljava/lang/String;J)Lcom/google/android/exoplayer/upstream/cache/CacheSpan;
    //   7: astore_1
    //   8: aload_0
    //   9: aload_1
    //   10: invokespecial 300	com/google/android/exoplayer/upstream/cache/SimpleCache:startReadWriteNonBlocking	(Lcom/google/android/exoplayer/upstream/cache/CacheSpan;)Lcom/google/android/exoplayer/upstream/cache/CacheSpan;
    //   13: astore 4
    //   15: aload 4
    //   17: ifnull +8 -> 25
    //   20: aload_0
    ...
    //   24: areturn
    //   25: aload_0
    //   26: invokevirtual 303	java/lang/Object:wait	()V
    //   29: goto -21 -> 8
    //   32: astore_1
    //   33: aload_0
    //   34: monitorexit
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/exoplayer/upstream/cache/SimpleCache.class
