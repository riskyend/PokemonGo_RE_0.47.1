  ...
  implements SampleSource, SampleSource.SampleSourceReader, Loader.Callback
{
  ...
  private void buildTracks(HlsExtractorWrapper paramHlsExtractorWrapper)
  {
    ...
    if (j < i2)
    {
      localObject = paramHlsExtractorWrapper.getMediaFormat(j).mimeType;
      int i1;
    ...
    label362:
    for (Object localObject = localMediaFormat.copyAsAdaptive(null);; localObject = copyWithFixedTrackInfo(localMediaFormat, ((Variant)localObject).format))
    {
  ...
  private static MediaFormat copyWithFixedTrackInfo(MediaFormat paramMediaFormat, Format paramFormat)
  {
    int i;
    ...
    {
      return paramMediaFormat.copyWithFixedTrackInfo(paramFormat.id, paramFormat.bitrate, i, j, paramFormat.language);
      i = paramFormat.width;
      break;
    }
  }
  ...
  public int readData(int paramInt, long paramLong, MediaFormatHolder paramMediaFormatHolder, SampleHolder paramSampleHolder)
  {
    ...
    if ((this.downstreamFormat == null) || (!this.downstreamFormat.equals(((HlsExtractorWrapper)localObject1).format)))
    {
      notifyDownstreamFormatChanged(((HlsExtractorWrapper)localObject1).format, ((HlsExtractorWrapper)localObject1).trigger, ((HlsExtractorWrapper)localObject1).startTimeUs);
      this.downstreamFormat = ((HlsExtractorWrapper)localObject1).format;
    }
    if (this.extractors.size() > 1) {
    ...
    Object localObject2 = ((HlsExtractorWrapper)localObject1).getMediaFormat(j);
    if ((localObject2 != null) && (!((MediaFormat)localObject2).equals(this.downstreamMediaFormats[paramInt])))
    {
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/exoplayer/hls/HlsSampleSource.class
