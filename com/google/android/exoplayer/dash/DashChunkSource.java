  ...
  implements ChunkSource, DashTrackSelector.Output
{
  ...
  {
    this(null, paramMediaPresentationDescription, paramDashTrackSelector, paramDataSource, paramFormatEvaluator, new com.google.android.exoplayer.util.SystemClock(), 0L, 0L, false, null, null, 0);
  }
  ...
  {
    this(paramManifestFetcher, (MediaPresentationDescription)paramManifestFetcher.getManifest(), paramDashTrackSelector, paramDataSource, paramFormatEvaluator, new com.google.android.exoplayer.util.SystemClock(), paramLong1 * 1000L, paramLong2 * 1000L, true, paramHandler, paramEventListener, paramInt);
  }
  ...
  {
    this(paramManifestFetcher, (MediaPresentationDescription)paramManifestFetcher.getManifest(), paramDashTrackSelector, paramDataSource, paramFormatEvaluator, new com.google.android.exoplayer.util.SystemClock(), paramLong1 * 1000L, paramLong2 * 1000L, paramBoolean, paramHandler, paramEventListener, paramInt);
  }
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/exoplayer/dash/DashChunkSource.class
