...
final class CuePainter
{
  ...
  public CuePainter(Context paramContext)
  {
  ...
  public void draw(Cue paramCue, boolean paramBoolean, CaptionStyleCompat paramCaptionStyleCompat, float paramFloat1, float paramFloat2, Canvas paramCanvas, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramInt3 = this.parentRight - this.parentLeft;
    ...
    for (paramCue = Layout.Alignment.ALIGN_CENTER;; paramCue = this.cueTextAlignment)
    {
      ...
      paramInt2 = 0;
      paramInt4 = this.textLayout.getLineCount();
      paramInt1 = 0;
      while (paramInt1 < paramInt4)
      {
        paramInt2 = Math.max((int)Math.ceil(this.textLayout.getLineWidth(paramInt1)), paramInt2);
        paramInt1 += 1;
      }
    }
    paramInt2 += i * 2;
    ...
    {
      paramInt1 = Math.round(paramInt3 * this.cuePosition) + this.parentLeft;
    ...
    for (;;)
    {
      ...
      paramInt1 = Math.round(this.cueLine * paramInt1) + this.parentBottom;
      break label759;
      label972:
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/exoplayer/text/CuePainter.class
