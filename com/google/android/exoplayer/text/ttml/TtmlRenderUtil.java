...
final class TtmlRenderUtil
{
  public static void applyStylesToSpan(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, TtmlStyle paramTtmlStyle)
  {
    ...
    if (paramTtmlStyle.hasColorSpecified()) {
      paramSpannableStringBuilder.setSpan(new ForegroundColorSpan(paramTtmlStyle.getColor()), paramInt1, paramInt2, 33);
    }
    if (paramTtmlStyle.hasBackgroundColorSpecified()) {
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/exoplayer/text/ttml/TtmlRenderUtil.class
