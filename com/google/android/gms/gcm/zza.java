...
class zza
{
  ...
  private Notification zzw(Bundle paramBundle)
  {
    ...
    paramBundle = new NotificationCompat.Builder(this.mContext).setSmallIcon(i).setAutoCancel(true).setContentIntent(paramBundle).setContentTitle((CharSequence)localObject).setContentText(str);
    if (localUri != null) {
  ...
  private PendingIntent zzx(Bundle paramBundle)
  {
    ...
    return PendingIntent.getActivity(this.mContext, zzvW(), (Intent)localObject, 1073741824);
  }
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/gms/gcm/zza.class
