...
public class zzd
{
  ...
  private boolean zza(PackageInfo paramPackageInfo, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    for (paramPackageInfo = zzc.zznp(); paramPackageInfo.contains(localzzb); paramPackageInfo = zzc.zznq()) {
      return true;
    }
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/gms/common/zzd.class
