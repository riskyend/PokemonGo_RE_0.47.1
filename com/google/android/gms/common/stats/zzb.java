...
public class zzb
{
  ...
  {
    int i = getLogLevel();
    return (!this.zzahz.contains(paramString1)) && (!this.zzahA.contains(paramString2)) && (!this.zzahB.contains(paramString3)) && (!this.zzahC.contains(paramString4)) && ((!paramString3.equals(paramString1)) || ((i & zzd.zzahS) == 0));
  }
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/gms/common/stats/zzb.class
