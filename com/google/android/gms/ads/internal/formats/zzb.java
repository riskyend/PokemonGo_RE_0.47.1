  ...
  extends RelativeLayout
{
  ...
  public zzb(Context paramContext, zza paramzza)
  {
    ...
    this.zzwk.setLayoutParams((ViewGroup.LayoutParams)localObject1);
    zzp.zzbx().zza(this.zzwk, (Drawable)localObject2);
    ...
    if (((List)localObject1).size() > 1)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        this.zzwl.addFrame((Drawable)localObject2, paramzza.zzdt());
      }
      zzp.zzbx().zza(paramContext, this.zzwl);
    }
    for (;;)
    {
      this.zzwk.addView(paramContext);
      addView(this.zzwk);
      return;
      if (((List)localObject1).size() == 1) {
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/android/gms/ads/internal/formats/zzb.class
