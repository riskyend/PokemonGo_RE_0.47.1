...
public class UiUtils
{
  ...
  public static void launchOrInstallCardboard(Context paramContext, boolean paramBoolean)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if (str.startsWith("com.google."))
      {
        ...
        localIntent2.setClassName(str, localResolveInfo.activityInfo.name);
    ...
    extends DialogFragment
  {
    ...
    public Dialog onCreateDialog(Bundle paramBundle)
    {
      ...
      paramBundle.setTitle(Strings.getString("DIALOG_TITLE")).setMessage(Strings.getString("DIALOG_MESSAGE_SETUP")).setPositiveButton(Strings.getString("SETUP_BUTTON"), this.listener).setNegativeButton(Strings.getString("CANCEL_BUTTON"), null);
    ...
    extends DialogFragment
  {
    ...
    {
      paramBundle = new AlertDialog.Builder(getActivity());
      paramBundle.setTitle(Strings.getString("DIALOG_TITLE")).setMessage(Strings.getString("DIALOG_MESSAGE_NO_CARDBOARD")).setPositiveButton(Strings.getString("GO_TO_PLAYSTORE_BUTTON"), this.listener).setNegativeButton(Strings.getString("CANCEL_BUTTON"), null);
      return paramBundle.create();
    }
  }
}
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/google/vr/cardboard/UiUtils.class
