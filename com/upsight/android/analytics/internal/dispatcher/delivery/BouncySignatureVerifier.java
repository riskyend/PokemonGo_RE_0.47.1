  ...
  BouncySignatureVerifier(UpsightContext paramUpsightContext)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramUpsightContext))
      {
        ...
        this.mLogger.d("Upsight", "Public key: " + paramUpsightContext, new Object[0]);
        return;
      }
    ...
    {
      this.mLogger.e("Upsight", paramUpsightContext, "Failed to initialize " + BouncySignatureVerifier.class.getSimpleName(), new Object[0]);
      return;
    }
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/upsight/android/analytics/internal/dispatcher/delivery/BouncySignatureVerifier.class
