...
public class RouterBuilder
{
  ...
  private Map<String, Queue> buildQueues(RoutingConfig paramRoutingConfig, Selector<Schema> paramSelector1, Selector<Schema> paramSelector2)
  {
    ...
    while (paramRoutingConfig.hasNext())
    {
      ...
      localHashMap.put(((Map.Entry)localObject).getKey(), this.mQueueBuilder.build((String)((Map.Entry)localObject).getKey(), (QueueConfig)((Map.Entry)localObject).getValue(), paramSelector1, paramSelector2));
    }
    return localHashMap;
  }
  ...
  public Router build(RoutingConfig paramRoutingConfig, Selector<Schema> paramSelector1, Selector<Schema> paramSelector2, RoutingListener paramRoutingListener)
  {
    ...
    paramRoutingConfig = new Router(this.mScheduler, new ByFilterSelector(paramRoutingConfig), paramRoutingListener);
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/upsight/android/analytics/internal/dispatcher/routing/RouterBuilder.class
