  ...
  extends android.content.ContentProvider
{
  ...
  public int delete(Uri paramUri, String paramString, String[] paramArrayOfString)
  {
    ...
    int i = this.mDataHelper.delete(paramString, paramArrayOfString);
    if (i > 0) {
  ...
  public Cursor query(Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    ...
    case 1: 
      ...
      return this.mDataHelper.query(paramArrayOfString1, paramUri, paramArrayOfString2, paramString2);
    case 2: 
      paramUri = paramUri.getLastPathSegment();
      return this.mDataHelper.query(paramArrayOfString1, "type = ?", new String[] { paramUri }, paramString2);
    }
    return this.mDataHelper.query(paramArrayOfString1, paramString1, paramArrayOfString2, paramString2);
  }
  ...
  public int update(Uri paramUri, ContentValues paramContentValues, String paramString, String[] paramArrayOfString)
  {
    ...
    paramString = updatedSelection(paramString, paramUri.getLastPathSegment());
    int i = this.mDataHelper.update(paramContentValues, paramString, paramArrayOfString);
    if (i > 0) {
      getContext().getContentResolver().notifyChange(paramUri, null);
    }
    return i;
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/upsight/android/internal/persistence/ContentProvider.class
