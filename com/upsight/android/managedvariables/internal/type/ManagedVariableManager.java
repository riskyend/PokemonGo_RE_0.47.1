...
public class ManagedVariableManager
{
  ...
  private <T extends ManagedVariable> T fromModel(Class<T> paramClass, String paramString, ManagedVariableModel paramManagedVariableModel)
  {
    ...
    {
      str = (String)localBaseSchema.defaultValue;
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (Boolean)localBaseSchema.defaultValue;
      ...
      {
        localObject1 = (Integer)localBaseSchema.defaultValue;
      ...
      else
      {
        ...
        {
          localObject1 = (Float)localBaseSchema.defaultValue;
          paramClass = str;
          if (paramManagedVariableModel != null) {
            paramClass = paramManagedVariableModel.getValue();
          }
  ...
  private <T extends ManagedVariable> void resetValue(Class<T> paramClass, String paramString)
  {
    ...
    {
      paramString = (ManagedVariable)this.mCache.get(paramString);
  ...
  public <T extends ManagedVariable> T fetch(Class<T> paramClass, String paramString)
  {
    synchronized (this.mCache)
    {
      ...
      this.mCache.put(paramString, localManagedVariable);
      paramClass = localManagedVariable;
    }
  }
  ...
  public <T extends ManagedVariable> UpsightSubscription fetch(final Class<T> paramClass, final String paramString, final UpsightManagedVariable.Listener<T> paramListener)
  {
    synchronized (this.mCache)
    {
      ...
      if (localManagedVariable != null)
      {
        paramClass = Subscriptions.from(Observable.just(localManagedVariable).observeOn(this.mCallbackScheduler).subscribe(new Action1()
        {
      ...
      paramClass = Subscriptions.from(fetchDataStoreObservable(paramClass, paramString).subscribe(new Action1()new Action1
      {
        public void call(ManagedVariableModel paramAnonymousManagedVariableModel)
        {
          for (;;)
          {
            ...
            {
              ManagedVariable localManagedVariable = (ManagedVariable)ManagedVariableManager.this.mCache.get(paramString);
              if (localManagedVariable != null)
              {
              ...
              {
                ManagedVariableManager.this.mCache.put(paramString, paramAnonymousManagedVariableModel);
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/upsight/android/managedvariables/internal/type/ManagedVariableManager.class
