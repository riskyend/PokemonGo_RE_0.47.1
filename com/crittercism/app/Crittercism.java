...
public class Crittercism
{
  ...
  public static void endTransaction(String paramString)
  {
    ...
    catch (ThreadDeath paramString)
    {
      synchronized (localaz.z)
      {
        paramString = (Transaction)localaz.z.remove(paramString);
        if (paramString != null)
        {
          paramString.b();
          return;
  ...
  public static AlertDialog generateRateMyAppAlertDialog(Context paramContext)
  {
    for (;;)
    {
      ...
      {
        az localaz = az.A();
        localObject = localaz.A;
        if (localaz.A != null)
        {
          str = localaz.A.b();
          localObject = localaz.A.c();
  ...
  public static void sendAppLoadData()
  {
    try
    {
      ...
      if (((CrittercismConfig)localObject).delaySendingAppLoad())
      {
        ...
        localObject = az.A();
        if (!((az)localObject).u.delaySendingAppLoad())
        {
    ...
    {
      throw localThreadDeath;
      if ((localThreadDeath.t) || (localThreadDeath.C)) {
        return;
      }
      localThreadDeath.C = true;
      az.1 local1 = new az.1(localThreadDeath);
      if (localThreadDeath.q.a(local1)) {
        return;
      }
      localThreadDeath.s.execute(local1);
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public static void setTransactionValue(String paramString, int paramInt)
  {
    try
    {
      ...
      synchronized (localaz.z)
      {
        paramString = (Transaction)localaz.z.get(paramString);
        if (paramString != null) {
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/crittercism/app/Crittercism.class
