  ...
  implements Cache
{
  ...
  public Cache.Entry get(String paramString)
  {
    ...
    //   47: dup
    //   48: new 306	java/io/BufferedInputStream
    //   51: dup
    //   52: new 308	java/io/FileInputStream
    //   55: dup
    //   56: aload 7
    //   58: invokespecial 310	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   61: invokespecial 313	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   64: aconst_null
    //   65: invokespecial 316	com/android/volley/toolbox/DiskBasedCache$CountingInputStream:<init>	(Ljava/io/InputStream;Lcom/android/volley/toolbox/DiskBasedCache$1;)V
    //   68: astore_3
    //   69: aload_3
    //   70: invokestatic 320	com/android/volley/toolbox/DiskBasedCache$CacheHeader:readHeader	(Ljava/io/InputStream;)Lcom/android/volley/toolbox/DiskBasedCache$CacheHeader;
    //   73: pop
    //   74: aload 4
    //   76: aload_3
    //   77: aload 7
    //   79: invokevirtual 322	java/io/File:length	()J
    //   82: aload_3
    //   83: invokestatic 326	com/android/volley/toolbox/DiskBasedCache$CountingInputStream:access$100	(Lcom/android/volley/toolbox/DiskBasedCache$CountingInputStream;)I
    //   86: i2l
    //   87: lsub
    //   88: l2i
    //   89: invokestatic 209	com/android/volley/toolbox/DiskBasedCache:streamToBytes	(Ljava/io/InputStream;I)[B
    //   92: invokevirtual 330	com/android/volley/toolbox/DiskBasedCache$CacheHeader:toCacheEntry	([B)Lcom/android/volley/Cache$Entry;
    //   95: astore_2
    //   96: aload_3
    //   97: ifnull +7 -> 104
    //   100: aload_3
    //   101: invokevirtual 333	com/android/volley/toolbox/DiskBasedCache$CountingInputStream:close	()V
    //   104: aload_2
    //   105: astore_1
    //   106: goto -78 -> 28
    //   109: astore_1
    ...
    //   131: iconst_0
    //   132: aload 7
    //   134: invokevirtual 338	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   137: aastore
    //   138: dup
    //   139: iconst_1
    //   140: aload 4
    //   142: invokevirtual 339	java/io/IOException:toString	()Ljava/lang/String;
    //   145: aastore
    //   146: invokestatic 168	com/android/volley/VolleyLog:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   149: aload_3
    //   150: astore_2
    //   151: aload_0
    //   152: aload_1
    //   153: invokevirtual 341	com/android/volley/toolbox/DiskBasedCache:remove	(Ljava/lang/String;)V
    //   156: aload 5
    //   158: astore_1
    //   159: aload_3
    //   160: ifnull -132 -> 28
    //   163: aload_3
    //   164: invokevirtual 333	com/android/volley/toolbox/DiskBasedCache$CountingInputStream:close	()V
    //   167: aload 5
    //   169: astore_1
    //   170: goto -142 -> 28
    //   173: astore_1
    ...
    //   182: ifnull +7 -> 189
    //   185: aload_2
    //   186: invokevirtual 333	com/android/volley/toolbox/DiskBasedCache$CountingInputStream:close	()V
    //   189: aload_1
    //   190: athrow
    //   191: astore_1
    //   192: aload_0
  ...
  public void initialize()
  {
    ...
    //   78: aconst_null
    //   79: astore 5
    //   81: new 306	java/io/BufferedInputStream
    //   84: dup
    //   85: new 308	java/io/FileInputStream
    //   88: dup
    //   89: aload 7
    //   91: invokespecial 310	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   94: invokespecial 313	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   97: astore 4
    //   99: aload 4
    //   101: invokestatic 320	com/android/volley/toolbox/DiskBasedCache$CacheHeader:readHeader	(Ljava/io/InputStream;)Lcom/android/volley/toolbox/DiskBasedCache$CacheHeader;
    //   104: astore_3
    //   105: aload_3
    //   106: aload 7
    //   108: invokevirtual 322	java/io/File:length	()J
    //   111: putfield 146	com/android/volley/toolbox/DiskBasedCache$CacheHeader:size	J
    //   114: aload_0
    //   115: aload_3
    //   116: getfield 134	com/android/volley/toolbox/DiskBasedCache$CacheHeader:key	Ljava/lang/String;
    //   119: aload_3
    //   120: invokespecial 358	com/android/volley/toolbox/DiskBasedCache:putEntry	(Ljava/lang/String;Lcom/android/volley/toolbox/DiskBasedCache$CacheHeader;)V
    //   123: aload 4
    //   125: ifnull +8 -> 133
    //   128: aload 4
    //   130: invokevirtual 359	java/io/BufferedInputStream:close	()V
    //   133: iload_1
    //   134: iconst_1
    //   135: iadd
    //   136: istore_1
    ...
    //   156: astore_3
    //   157: aload 7
    //   159: invokevirtual 143	java/io/File:delete	()Z
    //   162: pop
    //   163: aload 4
    //   165: ifnull -32 -> 133
    //   168: aload 4
    //   170: invokevirtual 359	java/io/BufferedInputStream:close	()V
    //   173: goto -40 -> 133
    //   176: astore_3
    //   177: goto -44 -> 133
    //   180: astore 4
    ...
    //   183: ifnull +7 -> 190
    //   186: aload_3
    //   187: invokevirtual 359	java/io/BufferedInputStream:close	()V
    //   190: aload 4
    //   192: athrow
    //   193: astore_3
    //   194: aload_0
  ...
  public void put(String paramString, Cache.Entry paramEntry)
  {
    ...
    //   20: dup
    //   21: new 384	java/io/FileOutputStream
    //   24: dup
    //   25: aload_3
    //   26: invokespecial 385	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   29: invokespecial 388	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   32: astore 4
    //   34: new 10	com/android/volley/toolbox/DiskBasedCache$CacheHeader
    //   37: dup
    //   38: aload_1
    //   39: aload_2
    //   40: invokespecial 390	com/android/volley/toolbox/DiskBasedCache$CacheHeader:<init>	(Ljava/lang/String;Lcom/android/volley/Cache$Entry;)V
    //   43: astore 5
    //   45: aload 5
    //   47: aload 4
    //   49: invokevirtual 394	com/android/volley/toolbox/DiskBasedCache$CacheHeader:writeHeader	(Ljava/io/OutputStream;)Z
    //   52: ifne +61 -> 113
    //   55: aload 4
    //   57: invokevirtual 395	java/io/BufferedOutputStream:close	()V
    //   60: ldc_w 397
    //   63: iconst_1
    ...
    //   68: iconst_0
    //   69: aload_3
    //   70: invokevirtual 338	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   73: aastore
    //   74: invokestatic 168	com/android/volley/VolleyLog:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   77: new 186	java/io/IOException
    //   80: dup
    //   81: invokespecial 398	java/io/IOException:<init>	()V
    //   84: athrow
    //   85: astore_1
    //   86: aload_3
    //   87: invokevirtual 143	java/io/File:delete	()Z
    //   90: ifne +20 -> 110
    //   93: ldc_w 400
    //   96: iconst_1
    ...
    //   101: iconst_0
    //   102: aload_3
    //   103: invokevirtual 338	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   106: aastore
    //   107: invokestatic 168	com/android/volley/VolleyLog:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   110: aload_0
    //   111: monitorexit
    //   112: return
    //   113: aload 4
    //   115: aload_2
    //   116: getfield 378	com/android/volley/Cache$Entry:data	[B
    //   119: invokevirtual 403	java/io/BufferedOutputStream:write	([B)V
    //   122: aload 4
    //   124: invokevirtual 395	java/io/BufferedOutputStream:close	()V
    //   127: aload_0
    //   128: aload_1
    //   129: aload 5
    //   131: invokespecial 358	com/android/volley/toolbox/DiskBasedCache:putEntry	(Ljava/lang/String;Lcom/android/volley/toolbox/DiskBasedCache$CacheHeader;)V
    //   134: goto -24 -> 110
    //   137: astore_1
    //   138: aload_0
    //   139: monitorexit
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/android/volley/toolbox/DiskBasedCache.class
