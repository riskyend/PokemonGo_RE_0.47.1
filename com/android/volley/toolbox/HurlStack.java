    ...
    throws IOException, AuthFailureError
  {
    ...
    if (this.mUrlRewriter != null)
    {
      ...
      if (paramMap == null)
      {
        ...
        for (paramRequest = "URL blocked by rewriter: ".concat(paramRequest);; paramRequest = new String("URL blocked by rewriter: ")) {
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/android/volley/toolbox/HurlStack.class
