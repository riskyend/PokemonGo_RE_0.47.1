    ...
    for (;;)
    {
      ...
      if (i < arrayOfStackTraceElement.length)
      {
        if (!arrayOfStackTraceElement[i].getClass().equals(VolleyLog.class))
        {
          ...
          str = String.valueOf(String.valueOf(arrayOfStackTraceElement[i].getMethodName()));
          paramVarArgs = paramVarArgs.length() + 1 + str.length() + paramVarArgs + "." + str;
        }
      }
      else
      {
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/android/volley/VolleyLog.class
