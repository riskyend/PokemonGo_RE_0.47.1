  ...
  implements TextWatcher, View.OnClickListener
{
  ...
  public j(Context paramContext, UnityPlayer paramUnityPlayer, String paramString1, int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString2)
  {
    super(paramContext);
    this.a = paramContext;
  ...
  protected final View createSoftInputView()
  {
    ...
    Object localObject = new EditText(this.a)
    {
      ...
      public final void onWindowFocusChanged(boolean paramAnonymousBoolean)
      {
        ...
        if (paramAnonymousBoolean) {
          ((InputMethodManager)j.b(j.this).getSystemService("input_method")).showSoftInput(this, 0);
        }
      }
    };
...
/* Location:              /Users/mohamedtajjiou/Downloads/Rerverse Engeneering/dex2jar-2.0/com.nianticlabs.pokemongo_0.47.1-2016111700_minAPI19(armeabi-v7a)(nodpi)_apkmirror.com (1)-dex2jar.jar!/com/unity3d/player/j.class
